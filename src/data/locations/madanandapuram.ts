...
export const madanandapuramData: MadanandapuramData = {
  ...
  amenities: {
    heading: "Amenities",
    items: [
      { id: "1", title: "Kitchen", iconName: "UtensilsCrossed" },
      { id: "2", title: "Washing Machine", iconName: "WashingMachine" },
      { id: "3", title: "CCTV", iconName: "Cctv" },
      { id: "4", title: "Geyser", iconName: "Flame" },
      { id: "5", title: "AC room", iconName: "AirVent" },
      { id: "6", title: "Kettle", iconName: "Coffee" },
      { id: "7", title: "TV", iconName: "Tv" },
      { id: "8", title: "Wi-Fi", iconName: "Wifi" },
      { id: "9", title: "Induction stove", iconName: "Flame" },
      { id: "10", title: "Microwave", iconName: "Microwave" },
      { id: "11", title: "Digital Lock", iconName: "Lock" },
      { id: "12", title: "Caretaker", iconName: "UserCheck" },
      { id: "13", title: "Fire extinguisher", iconName: "ShieldAlert" },
    ],
  },
  aboutProperty: {
