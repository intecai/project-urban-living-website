...
export default function HeroSection({ data }: HeroSectionProps) {
  ...
  return (
    <section className="relative w-full overflow-hidden font-figtree py-20 lg:py-28 min-h-[540px] lg:min-h-[620px] flex items-center">
      {/* Complete Full Bleed Background Image (homeHero.png) */}
      <div className="absolute inset-0 z-0 pointer-events-none">
        ...
        />
        {/* Soft Left Overlay Gradient for Text Contrast */}
